...
import plugin2 from "tailwindcss/plugin.js";
...
var corePlugin = plugin(({ addUtilities }) => {
...
// src/plugin/index.ts
var skeleton = plugin2.withOptions(
  // Plugin Creator
  (options) => {
...
function contentPath(fileURL, framework) {
  ...
  const require2 = createRequire(fileURL);
